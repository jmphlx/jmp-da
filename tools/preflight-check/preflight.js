...
const ICONS = {
  success: html`<svg class="icon" viewBox="0 0 20 20" aria-hidden="true">
  ...
  info: html`<svg class="icon" viewBox="0 0 20 20" aria-hidden="true">
  ...
  warn: html`<svg class="icon" viewBox="0 0 20 20" aria-hidden="true">
  ...
  error: html`<svg class="icon" viewBox="0 0 20 20" aria-hidden="true">
