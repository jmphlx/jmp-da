...
test(`Sample test`, async ({page}, testInfo) => {
  ...
  const urlMain = `https://main--jmp-da--jmphlx.hlx.live/en/sandbox/laurel/aem-168`;
...
test(`Subnav Block`, async ({page}, testInfo) => {
  ...
  const urlMain = `https://main--jmp-da--jmphlx.hlx.live/en/sandbox/laurel/subnav/medical`;
